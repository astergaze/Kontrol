        ...
        <section className="job-info">
          <div className="left-col">
            <div className="field-row">
              ...
              <input id="razon" className="value-input" />
            </div>
            <div className="field-row">
              <label htmlFor="resp">Resp:</label>
              <input id="resp" className="value-input" />
            </div>
            <div className="field-row">
              <label htmlFor="contact">Mail/Tel/Cel:</label>
              <input id="contact" className="value-input" />
            </div>
            <div className="field-row">
              <label htmlFor="dir">Dir:</label>
              <input id="dir" className="value-input" />
            </div>
          </div>
          <div className="right-col">
            <div className="field-row">
              <label htmlFor="ot">O/T Nº:</label>
              <input id="ot" className="value-input" />
            </div>
            <div className="field-row">
              <label htmlFor="fecha">Fecha:</label>
              <input id="fecha" className="value-input" />
            </div>
            <div className="field-row">
              <label htmlFor="fentrega">F/Entrega:</label>
              <input id="fentrega" className="value-input" />
            </div>
            <div className="field-row">
              <label>Arch:</label>
              <div className="checkboxes">
                <label>
                  <input type="radio" name="arch" value="mail" /> Mail
                </label>
                <label>
                  <input type="radio" name="arch" value="serv" /> Serv.
                </label>
                <label>
                  <input type="radio" name="arch" value="otro" /> Otro
                </label>
              </div>
            </div>
          </div>
          ...
          <div className="items-columns">
              ...
              <div className="col-rows">
                {Array.from({ length: 10 }).map((_, i) => (
                  <div key={i} className="row-cell">
                    <input className="cell-input small" defaultValue={i + 1} />
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="col originals">
              ...
              <div className="col-rows">
                {Array.from({ length: 10 }).map((_, i) => (
                  <div key={i} className="row-cell">
                    <input className="cell-input small" />
                  </div>
                ))}
              </div>
            </div>
        ...
        <section className="bottom-area">
          <div className="left-controls">
            <div className="field-row priority">
              ...
              <label>
                <input type="radio" name="prioridad" value="A" /> A
              </label>
              <label>
                <input type="radio" name="prioridad" value="M" /> M
              </label>
              <label>
                <input type="radio" name="prioridad" value="B" /> B
              </label>
            </div>
            <div className="field-row">
              <label>
                <input type="radio" name="envio" value="retira" /> Retira
              </label>
              <label>
                <input type="radio" name="envio" value="envia" /> Envia
              </label>
            </div>
            <div className="field-row">
              <label>
                <input type="radio" name="doc" value="rem" /> Rem.
              </label>
              <label>
                <input type="radio" name="doc" value="fact" /> Fact.
              </label>
            </div>
          </div>
          <div className="right-bottom">
            <div className="observations">
              <textarea rows={4} placeholder="Obs:" />
            </div>
            <div className="save-wrapper">
              <button className="action-button save-button">Guardar</button>
            </div>
          </div>
        </section>
      </main>
